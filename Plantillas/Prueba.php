<?php
	...
	$Url = "http://localhost:9999/App.WebDeveloper/";
...
<body style="padding: 0; margin: 0;" bgcolor="d9d7ce" style="font-family: Arial; font-size: 12px;">
	...
	<div>
		<table style="margin:0 auto;" bgcolor="ffffff" border="0" cellspacing="0" cellpadding="0" width="600px">
			<tr>
				<td colspan="5">
					<img width="600px" src="<?php echo $Url; ?>Resources/Images/12928301_10153693639495326_2341979282073055358_n.jpg" />
				</td>
			</tr>
			<tr>
				<td width="10px"></td>
					...
					<table style="margin:0 auto;" bgcolor="ffffff" border="0" cellspacing="0" cellpadding="0" width="600px">
						<tr>
							...
							<td width="300px" valign="top">
								<a href="">
									<img style="border-radius: 10px;" width="100%" src="<?php echo $Url; ?>ImageFileStore/<?php echo $item['Image']; ?>" />
								</a>
							</td>
							<td width="10px"></td>
						...
						<tr>
							...
							<td colspan="3">
								<span>
									<img width="560" src="<?php echo $Url; ?>Resources/Images/Separator.png">
								</span>
							</td>
							<td width="20px"></td>
						</tr>
					...
					<div style="text-align: center;">
						<span>
							<a href="https://www.facebook.com/thejoseshop?_rdr=p" style="text-decoration: none;">
								<img style="margin:0 auto;" src="<?php echo $Url; ?>Resources/Images/Facebook.png" width="32" height="32" />
							</a>
						</span>
						<span>
							<a href="https://twitter.com/thejoseshop" style="text-decoration: none;">
								<img style="margin:0 auto;" src="<?php echo $Url; ?>Resources/Images/Twitter.png" width="32" height="32" />
							</a>
						</span>
						<span>
							<a href="https://pinterest.com/thejoseshop" style="text-decoration: none;">
								<img style="margin:0 auto;" src="<?php echo $Url; ?>Resources/Images/Pinterest.png" width="32" height="32" />
							</a>
						</span>
					</div>
				</td>
					...
					<span>
						<strong>
							<font face="Calibri" size=2 color="ffffff">
								© Copyright - <a href="" style="text-decoration: none; color:#fbe9e7;">NicDesign</a> <?php echo date("Y"); ?>
							</font>
						</strong>
					</span>
				</td>
				<td align="right" valign="middle">
					<span>
						...
						<a href="" style="text-decoration: none;">
							<img width="32px" height="32px" src="<?php echo $Url; ?>Resources/Images/Profile/12031434_651709138315117_3783905120307888826_o.png" />
						</a>
					</span>
				</td>
				<td width="10px"></td>
